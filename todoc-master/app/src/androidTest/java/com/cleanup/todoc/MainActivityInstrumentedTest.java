...
public class MainActivityInstrumentedTest {
    ...
    @Test
    public void itemViewIsEmpty() {
        // Element list is empty.
        onView(withId(R.id.list_tasks)).check(matches(hasMinimumChildCount(0)));
    }

    @Test
    public void createTaskAndTheRemoveItFomView() {
        ...
        onView(withId(R.id.list_tasks)).check(matches(hasMinimumChildCount(1)));
    ...
    @Test
    public void createAndRemoveSortTasksInTheView() {
        onView(withId(R.id.fab_add_task)).perform(click());
        ...
        onView(withRecyclerView(R.id.list_tasks).atPositionOnView(2, R.id.lbl_task_name))
                .check(matches(withText("aaa Tâche example")));
        // Check that it contains one element only
        onView(withId(R.id.list_tasks)).check(matches(hasMinimumChildCount(3)));
